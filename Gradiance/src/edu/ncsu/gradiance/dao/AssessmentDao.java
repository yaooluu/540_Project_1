...
/**
 * Home object for domain model class Assessment.
 * @see edu.ncsu.gradiance.dao.Assessment
...
public class AssessmentDao {
	...
	public void persist(Assessment transientInstance) {
		log.debug("persisting Assessment instance");
		try {
	...
	public Assessment merge(Assessment detachedInstance) {
		...
		try {
			Assessment result = (Assessment) sessionFactory.getCurrentSession()
	...
	public Assessment findById(java.lang.Integer id) {
		...
		try {
			Assessment instance = (Assessment) sessionFactory
					.getCurrentSession().get(
							"edu.ncsu.gradiance.dao.Assessment", id);
			if (instance == null) {
	...
	public List findByExample(Assessment instance) {
		log.debug("finding Assessment instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("edu.ncsu.gradiance.dao.Assessment")
