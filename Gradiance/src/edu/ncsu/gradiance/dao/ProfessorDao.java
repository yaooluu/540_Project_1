 ...
 * @see edu.ncsu.gradiance.dao.Professor
...
public class ProfessorDao {
	...
	public Professor merge(Professor detachedInstance) {
		...
		try {
			Professor result = (Professor) sessionFactory.getCurrentSession()
	...
	public Professor findById(java.lang.Integer id) {
		...
		try {
			Professor instance = (Professor) sessionFactory.getCurrentSession()
					.get("edu.ncsu.gradiance.dao.Professor", id);
			if (instance == null) {
	...
	public List findByExample(Professor instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("edu.ncsu.gradiance.dao.Professor")
