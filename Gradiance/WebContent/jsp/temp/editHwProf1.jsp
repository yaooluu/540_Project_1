								...
								<tbody>
									...
									<tr valign="top" style="color: black;">
										...
										<td align="left" style="white-space: nowrap"><input type="text" style="width: 150px"
											name="startdate" placeholder="2014-10-31" disabled></td>	
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr>
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
										...
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td align="left" style="white-space: nowrap"><input type="text" style="width: 150px"
											name="enddate" placeholder="2014-10-31" disabled></td>
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr>
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
										...
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td align="left" style="white-space: nowrap"><input type="text" style="width: 150px"
											name="attemptnum" placeholder="0" disabled></td>
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr>
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
										...
										<input type="text" style="width: 150px"
											name="topics" placeholder="Introduction to database" disabled>
										</td>
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr>
										...
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td align="left" style="white-space: nowrap">
											<font size="2" color="darkgray">from&nbsp;
											<input type="text" style="width: 30px"
											name="diff1" placeholder="1" disabled>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to&nbsp;
											<input type="text" style="width: 30px"
											name="diff2" placeholder="5" disabled>
											</font>
										</td>
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr>
										...
										<td align="left" style="white-space: nowrap">
											<input type="text" style="width: 150px"
											name="scoreselection" placeholder="latest attempt" disabled>
										</td>
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr>
										...
										<td align="left" style="white-space: nowrap">
											<input type="text" style="width: 150px"
											name="questionnum" placeholder="0" disabled>
										</td>
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr>
										...
										<td align="left" style="white-space: nowrap">
											<input type="text" style="width: 150px"
											name="correctpts" placeholder="4" disabled>
										</td>
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr>
										...
										<td align="left" style="white-space: nowrap">
											<input type="text" style="width: 150px"
											name="incorrectpts" placeholder="2" disabled>
										</td>
										<td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
								</tbody>
