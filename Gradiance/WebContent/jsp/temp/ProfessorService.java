...
public class ProfessorService {
	...
	/**
	 * @author yaolu
	 * @function edit homework questions
	 */
	@POST
	@Path("editHomeworkQuestion")
	public Response editHomeworkQuestion(@Context HttpServletRequest request,
			@FormParam("aid") String aid, @FormParam("selectedQidList") String selectedQidList) throws Exception { 
		System.out.println("/prof/editHomeworkQuestion called at: "+System.currentTimeMillis());
